...
class TalashWidgets extends \Elementor\Widget_Base {
	...
	function register_content_controls() {
		...
		$this->add_control(
			'dummy_text',
			[
				'label'       => __( 'Dummy Text', 'talash' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'input_type'  => 'text',
				'placeholder' => __( 'Some Dummy Text', 'talash' ),
				'default'     => __( 'Elementor Blank Widget', 'talash' ),
			]
		);
	...
	protected function render() {
		...
		<?php
        echo do_shortcode('[talash-search]');
